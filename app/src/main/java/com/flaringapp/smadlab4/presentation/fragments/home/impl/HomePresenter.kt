package com.flaringapp.smadlab4.presentation.fragments.home.impl

import com.flaringapp.smadlab4.R
...
import com.flaringapp.smadlab4.presentation.mvp.BasePresenter
import io.reactivex.disposables.Disposable
import java.text.DecimalFormat

class HomePresenter(
    private val varianceAnalyzer: VarianceAnalyzer
    ...
    companion object {
        ...
        private const val DEFINED_INPUT_1 = "0.35 0.35 0.30 0.36 0.31 0.36 0.34 0.34"
        private const val DEFINED_INPUT_2 = "0.32 0.36 0.37 0.37 0.37 0.30 0.38 0.42"
        private const val DEFINED_INPUT_3 = "0.32 0.31 0.36 0.33 0.40 0.42 0.43 0.41"
        private const val DEFINED_INPUT_4 = "0.35 0.38 0.42 0.47 0.60 0.91 0.89 0.59"
    }
    ...
    private fun tryToCalculate() {
        ...
        calculationRequest?.dispose()
        calculationRequest = varianceAnalyzer.analyze(
            arrayOf(
            ...
            .subscribe(
                {
                    view?.setIntergroupVariance(decimalFormat.format(it.intergroupVariance))
                    ...
                    view?.setFisherCriterion(decimalFormat.format(it.fisherCriterion))
                },
                { view?.handleError(it) }
            )
    }
